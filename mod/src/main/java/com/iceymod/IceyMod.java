...
public class IceyMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        System.out.println("[IceyMod] booted (build tag: v1.86.59)");
        ...
        // Health HUD now handled by the bundled HealthIndicators mod
        // (auto-installed by the launcher alongside iceymod).
